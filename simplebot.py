...
#title of the baseWindow
baseWindow.title("The Simple Chat Bot")

#size of baseWindow
baseWindow.geometry("500x250")

#chat window as scrolledtext widget with Arial font
chatWindow = tks.ScrolledText(baseWindow, font="Arial")

#configure tags for message alignment left for bot , right for user
